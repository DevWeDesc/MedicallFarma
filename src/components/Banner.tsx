...
import ImageBanner from "../../public/imageBannerProducts.png";
...
export const Banner = () => {
  return (
    <div
      ...
      className="bg-grayDark px-5 flex flex-col gap-8 py-16 xl:items-center xl:gap-28 xl:pt-24"
    >
      <div className="text-white flex flex-col gap-8">
        <h2 className="max-w-[387px] text-2xl xl:max-w-4xl font-light text-center xl:text-5xl">
